...
Nouvelles combinaisons de mise à niveau prises en charge pour les mises à niveau de contrôleurs IP MetroCluster à l'aide des commandes  `system controller replace`
 a| 
Ajoute la prise en charge de la mise à niveau d'un AFF A70 vers un système AFF A90 ou d'un FAS70 vers un FAS90 à l'aide de commandes  `system controller replace` dans une configuration IP MetroCluster.
