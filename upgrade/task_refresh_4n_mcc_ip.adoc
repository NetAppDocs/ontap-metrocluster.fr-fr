...
* Cette procédure n'est pas prise en charge sur les systèmes AFF A320 configurés avec des commutateurs Broadcom BES-53248.
* Cette procédure n'est pas prise en charge par les systèmes FAS2750, AFF A220, FAS500f et A250.
