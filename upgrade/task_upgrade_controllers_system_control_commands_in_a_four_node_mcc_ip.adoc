...
Pour que la mise en réseau puisse reprendre proprement sur les nouveaux contrôleurs, vérifiez que le placement des LIF est correct et supprimez la configuration réseau des anciens contrôleurs.
