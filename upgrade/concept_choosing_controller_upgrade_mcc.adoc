...
* Remarque 4 : Les mises à niveau des systèmes intégrés (disques et contrôleurs dans le même châssis) nécessitent le remplacement des modules de contrôleur tout en conservant le châssis et les disques existants.
...
image:../media/manual-upgrade-combination-group-2-a90-fas90-updated.png["La présente les combinaisons de mise à niveau prises en charge pour les plates-formes du groupe 2"]
