...
image:../media/mccip_manual_controller_upgrade_comb.png["La présente les plateformes AFF et FAS prises en charge pour la mise à niveau manuelle des contrôleurs via le basculement et le rétablissement"]
