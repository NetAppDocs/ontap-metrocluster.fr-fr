...
CAUTION: Si votre mise à niveau ne nécessite pas la définition d'arguments de démarrage, vous pouvez ignorer cette tâche et passer directement à link:upgrade-mcc-ip-system-controller-replace-prechecks.html["Préparez le système pour la mise à niveau"].
