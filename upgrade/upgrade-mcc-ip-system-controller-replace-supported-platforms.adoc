...
* Remarque 3 : Les mises à niveau des systèmes intégrés (disque et contrôleurs dans le même châssis) nécessitent le remplacement des modules de contrôleur tout en conservant le châssis et les disques existants.
* Remarque 4 : Nécessite des modules IOM pour convertir les anciens contrôleurs en un châssis SAS externe. Consultez la link:https://hwu.netapp.com/["Hardware Universe"^] pour connaître les modules IOM compatibles.
* Remarque 5 : Nécessite ONTAP 9.18.1GA ou version ultérieure.
...
image:../media/assisted-group-2-a70-a90-updated.png["Affiche les combinaisons de mise à niveau AFF et FAS groupe 2"]
