...
.Description de la tâche
* Vous avez besoin des UID et des ID système identifiés précédemment dans la procédure de mise à niveau de <<gather_info_so_sb,Recueillez les informations avant la mise à niveau>>.
