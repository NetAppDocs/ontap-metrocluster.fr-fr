...
e3a, e3b
 a| 
Aucun port correspondant. Après la mise à niveau, recréez les ports du cluster. link:task_prepare_cluster_ports_on_the_exist_controller.html["Préparation des ports de cluster sur un module de contrôleur existant"]
