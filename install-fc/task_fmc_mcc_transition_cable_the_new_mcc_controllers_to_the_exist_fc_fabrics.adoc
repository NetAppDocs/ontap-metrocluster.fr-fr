...
[role="lead"]
Sur chaque contrôleur de la configuration clustered ONTAP MetroCluster, l'adaptateur FC-VI et les HBA doivent être câblés à des ports spécifiques sur les commutateurs FC existants.
