...
image::../media/mcc_hardware_architecture_both_clusters.gif[architecture matérielle mcc deux clusters]
...
image::../media/mcc_hardware_architecture_cluster_a_with_7500n.gif[cluster d'architecture matérielle mcc a avec 7500n]
...
image::../media/mcc_hardware_architecture_both_clusters_2_node_fabric.gif[architecture matérielle mcc deux clusters structure à 2 nœuds]
...
image::../media/mcc_hardware_architecture_cluster_a_2_node_with_7500n.gif[architecture matérielle mcc en cluster avec 2 nœuds avec 7500n]
