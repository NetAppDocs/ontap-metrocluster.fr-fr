...
Pour obtenir des informations plus générales sur la configuration de ONTAP, reportez-vous au https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["Configuration ONTAP"]
...
[role="tabbed-block"]
====
.Dans ONTAP 9.6 et versions ultérieures
--
...
.Dans ONTAP 9.6 et versions ultérieures
--
Ron la commande : `network interface show -service-policy default-intercluster -failover`
...
NOTE: Si vous souhaitez utiliser un seul agrégat de données en miroir, reportez-vous à la section ,Étape 1 pour obtenir des instructions.
