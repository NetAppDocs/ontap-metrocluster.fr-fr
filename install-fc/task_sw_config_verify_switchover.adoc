...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[Configuration de nœuds et de clusters de haut niveau du flux de travail dans ONTAP]
...
* Les noms d'agrégats doivent être conformes au schéma de nommage que vous avez déterminé lors de la planification de votre configuration MetroCluster. Voir https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["Gestion des disques et des agrégats"^].
...
.Étape
. Utilisez les procédures négociées pour le basculement, la réparation et le rétablissement https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html["Gestion et reprise après incident MetroCluster"]
...
+
https://docs.netapp.com/us-en/ontap/system-admin/config-backup-file-concept.html["Gestion des sauvegardes de configuration"^] contient des informations supplémentaires.



.Informations associées
https://docs.netapp.com/us-en/ontap/cluster-admin/index.html["Administration du cluster"^]
