...
== Nombre de disques et de tiroirs pris en charge sur les ponts FibreBridge 7600N et 7500N

Les tableaux suivants indiquent le nombre de disques et de tiroirs pris en charge par une paire de ponts FibreBridge 7600N et 7500N.

[NOTE]
====
* La première limite atteinte s'applique.
* Si vous utilisez des tiroirs DS460C, vous pouvez utiliser seulement 240 disques, ce qui équivaut à 4 tiroirs.
* Si vous utilisez des tiroirs DS212C, seuls 120 disques peuvent être utilisés, ce qui équivaut à 10 tiroirs.


====
.Nombre de disques pris en charge
Vérifiez le nombre de disques pris en charge derrière une paire de ponts FibreBridge 7600N ou 7500N :

[cols="3*"]
|===
| Configuration de disque | Type de disque | Nombre total de disques par paire de ponts 


| Tous disques SSD | SSD | 96 


| Uniquement sur disques durs | DISQUES DURS | 240 


.2+| Mixte (96 SSD) | SSD | 96 


| DISQUES DURS | 144 


.2+| Mixte (72 SSD) | SSD | 72 


| DISQUES DURS | 168 


.2+| Mixte (48 SSD) | SSD | 48 


| DISQUES DURS | 192 


.2+| Mixte (24 SSD) | SSD | 24 


| DISQUES DURS | 216 
|===
.Nombre de tiroirs pris en charge
Vérifiez le nombre de tiroirs pris en charge derrière une paire de ponts FibreBridge 7600N et 7500N :

[cols="3*"]
|===
| Configuration de disque | Type de disque | Nombre total de tiroirs 


| Tous disques SSD | SSD | 4 


| Uniquement sur disques durs | DISQUES DURS | 10 
