...
---
= Configurez manuellement les commutateurs Cisco dans une configuration FC MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Informations associées
Vous devez vérifier que vous utilisez les affectations de ports spécifiées lors du câblage des commutateurs FC. Consultez link:concept_port_assignments_for_fc_switches_when_using_ontap_9_1_and_later.html["Affectations de ports pour les commutateurs FC"]
...
image::../media/fcip_ports_dual_isl.gif[Diagramme montrant les ports FCIP avec une configuration ISL double sur chaque commutateur]
...
Les étapes suivantes utilisent le zonage décrit dans la section Zonage pour un FibreBridge 7500N dans une configuration MetroCluster à quatre nœuds.
