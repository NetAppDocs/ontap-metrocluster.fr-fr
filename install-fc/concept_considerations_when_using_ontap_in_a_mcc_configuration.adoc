...
NOTE: Avant de configurer l'agrégat, vous devez configurer des magasins d'objets comme décrit dans la section « Configuration des magasins d'objets pour FabricPool dans une configuration MetroCluster » duhttps://["Gestion des disques et des agrégats"]
...
. Créer le miroir FabricPool avec l'agrégat, comme décrit dans la https://["Gestion des disques et des agrégats"]
+
...
ONTAP 9.11.1 et https://["groupes de cohérence"^] Sont prises en charge dans les configurations MetroCluster.
