...
image::../media/workflow_bridge_installation_and_configuration.gif[Flux de travail pour l'installation et la configuration d'un pont FC vers SAS]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[Câblage MetroCluster Configuration FibreBridge avec plusieurs piles SAS3]
