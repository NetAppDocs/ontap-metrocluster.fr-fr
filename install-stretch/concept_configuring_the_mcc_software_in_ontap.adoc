...
[[site-a-nbsp-autosupport-information]]
...
[[site-b-nbsp-autosupport-information]]
...
Pour plus d'informations générales sur la configuration ONTAP, consultez le link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html["Configuration ONTAP"^]
...
+
Le link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sag/home.html["Gestion du cluster via l'interface de ligne de commandes"^] contient des informations supplémentaires dans la section _Gestion des sauvegardes de configuration_.
