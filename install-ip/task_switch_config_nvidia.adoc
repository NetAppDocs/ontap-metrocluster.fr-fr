...
---
= Configurez les commutateurs NVIDIA IP SN2100 pour une configuration IP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[rcf-file-optionreset-the-switch-using-the-rcf-file-option]]
...
[[download-and-installdownload-and-install-the-nvidia-rcf-files]]
