...
---
= Tableaux de ports pour les configurations IP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous devez comprendre comment utiliser les informations contenues dans les tables de ports pour générer correctement vos fichiers de configuration de référence (RCFs).
