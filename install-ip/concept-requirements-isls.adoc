...
+
** À partir d' ONTAP 9.18.1, les plateformes avec une vitesse de port backend IP MetroCluster de 100G nécessitent une vitesse de liaison ISL minimale de 100Gbps. L'utilisation d'une vitesse ISL différente nécessite une demande de variation de fonctionnalité (FPVR). Pour déposer une réclamation FPVR, veuillez contacter votre équipe commerciale NetApp .
