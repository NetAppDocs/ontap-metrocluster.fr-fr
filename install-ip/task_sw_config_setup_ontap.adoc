...
Si vous devez démarrer en réseau les nouveaux contrôleurs, reportez-vous à la section link:../upgrade/task_upgrade_controllers_in_a_four_node_ip_mcc_us_switchover_and_switchback_mcc_ip.html#netboot-the-new-controllers["NetBoot les nouveaux modules de contrôleur"].
