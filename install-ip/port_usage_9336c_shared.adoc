...
| AFF A320, AFF C400, ASA C400, FAS8700 AFF A900, ASA A900 | <<table_7_cisco_9336c_fx2,Attributions de ports de plate-forme de commutateur partagé Cisco 9336C-FX2 (groupe 7)>> 
...
image::../media/mcc_ip_cabling_a_aff_a150_asa_a150_fas27500_aff_a220_to_a_cisco_9336c_shared_switch.png[La présente les attributions de ports de plate-forme de commutateur partagé Cisco 9336C-FX2]
...
image::../media/mcc_ip_cabling_c250_asa_c250_a250_asa_a250_to_cisco_9336c_shared_switch.png[La présente les attributions de ports de plate-forme de commutateur partagé Cisco 9336C-FX2]
...
image::../media/mcc_ip_cabling_fas8200_affa300_to_cisco_9336c_shared_switch.png[La présente les attributions de ports de plate-forme de commutateur partagé Cisco 9336C-FX2]

.Attributions de ports de plate-forme de commutateur partagé Cisco 9336C-FX2 (groupe 7)
Consultez les attributions de ports de plateforme pour connecter les systèmes AFF A320, FAS8300, AFF C400, ASA C400, FAS8700, système AFF A900 ou ASA A900 ne connectant pas des tiroirs NSS24 reliés par un commutateur partagé Cisco 9336C-FX2 :
