...
48 disques (disques externes et internes)
 a| 
Les partitions internes sont divisées en quatre groupes égaux (quarts). Chaque trimestre est attribué automatiquement à un pool distinct. Les disques des tiroirs externes sont divisés en quatre groupes égaux (trimestres). Chaque trimestre est attribué automatiquement à un pool distinct.
 a| 
