...
Vous devez suivre les étapes correspondant à la version du micrologiciel du commutateur prise en charge dans une configuration IP MetroCluster. Consultez le link:https://hwu.netapp.com["Hardware Universe"^] pour vérifier les versions de firmware prises en charge.
...
.Commutateurs Cisco
--
Configurez un nom d'utilisateur SNMPv3 SNMPv3_USER sur les commutateurs Cisco Nexus :
...
.NVIDIA - CL 5.4.0
--
Configurez un nom d'utilisateur SNMPv3 SNMPv3_USER sur les commutateurs NVIDIA Cumulus exécutant CL 5.4.0 :
...
.NVIDIA - CL 5.11.0+
--
Configurez un nom d'utilisateur SNMPv3 SNMPv3_USER sur les commutateurs NVIDIA Cumulus exécutant la CLI 5.11.0 et versions ultérieures :
