...
* Les systèmes AFF A30, AFF C30, AFF C60 et FAS50 nécessitent un adaptateur QSFP vers SFP+ sur la carte du contrôleur pour prendre en charge une vitesse réseau de 25 Gbit/s.
