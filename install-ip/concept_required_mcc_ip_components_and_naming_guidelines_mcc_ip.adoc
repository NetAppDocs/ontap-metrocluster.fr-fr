...
Votre version de ONTAP doit prendre en charge le mélange des tiroirs. Reportez-vous à la https://["Matrice d'interopérabilité NetApp (IMT)"] Pour vérifier si votre version de ONTAP prend en charge la combinaison de tiroirs.
