...
*Remarque :* 25 GbE speed nécessite l’adaptateur émetteur-récepteur MAM1Q00A-QSA28.
...
NOTE: Les noms des agrégats doivent être uniques sur l'ensemble des MetroCluster sites. Cela signifie que vous ne pouvez pas avoir deux agrégats différents portant le même nom sur le site A et le site B.
