...
* La prise en charge de la surveillance de plusieurs configurations IP MetroCluster à l'aide d'une seule instance ONTAP Mediator dépend de la configuration d'ONTAP Mediator avec HTTPS ou iSCSI. Pour plus d'informations, consultez link:concept_mediator_requirements.html#mediator-multiple-mccip["Utilisez ONTAP Mediator pour surveiller plusieurs configurations IP MetroCluster"].
