...
* Dans une configuration IP MetroCluster, suivez les étapes de la section link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_sw_config_verify_haconfig.html["Restaurez les paramètres par défaut du système sur un module de contrôleur"].
