...
=== Configuration des tiroirs avec FibreBridge 7500N ou 7600N utilisant les deux ports FC (FC1 ou FC2)

.MetroCluster 1 ou groupe DR 1
Le tableau suivant présente les configurations de tiroirs prises en charge dans MetroCluster 1 ou DR Groupe 1 pour les ponts FibreBridge 7500N ou 7600N utilisant les deux ports FC (FC1 ou FC2). Lorsque vous utilisez ce tableau de configuration, vous devez connaître les points suivants :
...
|===
Vous pouvez fixer des ponts supplémentaires à l'aide des ports 25 à 48 en suivant le même schéma.
