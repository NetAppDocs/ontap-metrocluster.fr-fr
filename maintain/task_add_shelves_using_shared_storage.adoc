...
NOTE: Si votre commutateur est déjà configuré correctement, vous pouvez passer directement à ces sections suivantes  MACsec encryption on Cisco 9336C switches, si applicable ou à  the new NS224 shelf.
