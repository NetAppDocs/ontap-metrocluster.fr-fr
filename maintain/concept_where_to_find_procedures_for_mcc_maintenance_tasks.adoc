...
Mise à niveau du micrologiciel
 a| 
link:maintain/task_upgrade_firmware_on_mcc_ip_switches.html["Mise à niveau du micrologiciel des commutateurs IP MetroCluster"]
...
Mise à niveau du fichier RCF
 a| 
link:maintain/task_upgrade_rcf_files_on_mcc_ip_switches.html["Mettre à niveau les fichiers RCF sur les commutateurs IP MetroCluster"]

link:maintain/task_upgrade_rcf_files_on_cisco_ip_switches_with_cleanupfiles.html["Mettre à niveau les fichiers RCF sur les commutateurs IP Cisco à l'aide de CleanUpFiles"]
...
Renommer un commutateur
 a| 
link:maintain/task_rename_a_cisco_ip_switch.html["Renommez un commutateur IP Cisco"]
