...
.. Configurez le nouveau commutateur comme décrit dans la procédure _MetroCluster installation and Configuration, mais ne passez pas à la procédure « Configuration de la segmentation sur les commutateurs Brocade FC ».
+
