...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Mise à niveau de Brocade vers G620 après achèvement]
...
----
+
image::../media/brocade_upgr_to_g620_fab_1_down.gif[Mise à niveau Brocade vers G620 avec fabric 1 désactivé]
...
+
image::../media/brocade_upgr_to_g620_replaced_a_1.gif[Mise à niveau de Brocade vers G620 avec remplacement de A1]
...
+
image::../media/brocade_upgr_to_g620_replaced_b_1.gif[Mise à niveau de Brocade vers G620 avec remplacement du B1]
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Workflow pour MetroCluster après le remplacement et la mise à niveau des commutateurs Brocade G620]
