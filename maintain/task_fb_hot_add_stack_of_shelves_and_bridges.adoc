...
Exact
 a| 
Recommencez ,Étape 11 pour chaque pont restant.
...
Incorrect
 a| 
.. Vérifiez que les câbles SAS ne sont pas correctement branchés ou corrigez le câblage SAS en répétant ,Étape 10.
.. Recommencez ,Étape 11.
