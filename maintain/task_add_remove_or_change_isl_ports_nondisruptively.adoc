...
NOTE: Si vous utilisez un commutateur Cisco 9336C-FX2 en configuration partagée pour connecter des baies NS224, la modification des ISL peut nécessiter un nouveau fichier de configuration (RCF). Vous ne nécessitez pas de nouveau RCF si vos vitesses ISL actuelles et nouvelles sont de 40 Gbps et 100 Gbps. Toute autre modification de la vitesse ISL nécessite un nouveau RCF. Par exemple, changer la vitesse ISL de 40 Gbps à 100 Gbps ne nécessite pas de nouveau RCF, mais changer la vitesse ISL de 10 Gbps à 40 Gbps nécessite un nouveau RCF.
...
NOTE: Si vous utilisez des commutateurs Cisco 9336C-FX2 en configuration partagée connectant des baies NS224, et que vous devez mettre à niveau le RCF et appliquer la nouvelle configuration aux nouveaux ports ISL, suivez les étapes à link:task_upgrade_rcf_files_on_mcc_ip_switches.html["Mettre à niveau les RCF sur les commutateurs IP MetroCluster."]
