...
image::../media/mcc_hw_architecture_local_ha.gif[HA local dans une configuration MetroCluster]
...
image::../media/mcc_mirroring_of_svms.gif[Mise en miroir des SVM par MetroCluster]
...
image::../media/mcc_svms_after_switchover.gif[SVM MetroCluster après le passage au numérique]
...
| Type de basculement | État de la configuration FC MetroCluster | État de configuration IP MetroCluster 
...
|===
*Remarque 1* : dans les configurations MetroCluster IP, une fois le basculement terminé, vous pouvez mettre manuellement les agrégats sans miroir en ligne.

En savoir plus sur <<Différences de basculement entre les configurations FC et IP de MetroCluster>>.
...
image::../media/mcc_mirroring_of_pools.gif[Mise en miroir des pools de stockage par MetroCluster]
...
| Dans une configuration MetroCluster | Dans une paire HA non MetroCluster 
 ...
 a| 
image:../media/mcc_nvram_quartering.gif["Mise en quarts du cache non volatile dans une configuration MetroCluster"]
 a| 
image:../media/mcc_nvram_split_in_non_mcc_ha_pair.gif["Division du cache non-volatile dans une paire HA non-MetroCluster"]
...
image::../media/mcc_nvram_mirroring_example.gif[Exemple de mise en miroir NVRAM de MetroCluster]
...
image::../media/mcc_nvram_mirroring_example_dynamic_dr_aux.gif[MetroCluster NVRAM mirroring avec DR auxiliaire]
...
image::../media/mcc_disk_ownership.gif[Propriété des disques MetroCluster]
...
image::../media/mcc_so_sb_with_autoheal.gif[Basculement et rétablissement de MetroCluster avec autoheal]
...
image::../media/mcc_uso_with_autoheal.gif[Commutation non programmée de MetroCluster avec autoheal]
