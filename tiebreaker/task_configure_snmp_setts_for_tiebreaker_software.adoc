...
---
= Configurer les paramètres SNMP pour le logiciel MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
link:concept_monitoring_the_mcc_configuration.html["Surveiller la configuration MetroCluster"]
