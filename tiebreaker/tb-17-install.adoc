...
---
= Installez MetroCluster Tiebreaker 1.7
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installez ou mettez à niveau Tiebreaker vers la version 1.7 sur votre hôte Linux pour surveiller les configurations MetroCluster .

.Description de la tâche
* Votre système de stockage doit exécuter ONTAP 9.12.1 ou une version ultérieure.
* Vous ne pouvez effectuer la mise à niveau vers Tiebreaker 1.7 qu'à partir de Tiebreaker 1.6P1. Se référer àlink:tb-16-install.html["Installez Tiebreaker 1.6 ou 1.6P1"] .
...
NOTE: Après avoir installé Tiebreaker 1.7, vous devez link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importer des certificats"] pour activer la surveillance continue.

.Étapes
. Téléchargez le logiciel MetroCluster Tiebreaker 1.7.
+
...
. Si vous effectuez une mise à niveau, vérifiez la version de Tiebreaker que vous utilisez :
+
L'exemple suivant illustre le bris d'égalité 1.6P1
...
[role="tabbed-block"]
====
.Installer Tiebreaker 1.7
--
Utilisez les étapes suivantes pour une nouvelle installation de Tiebreaker 1.7.
...
--
.Mise à niveau de la version 1.6P1 vers la version 1.7
--
Utilisez les étapes suivantes pour mettre à niveau la version du logiciel Tiebreaker 1.6P1 vers Tiebreaker 1.7.
...
NOTE: Si votre mise à niveau échoue en raison d'une erreur due à des certificats manquants, consultez la documentation.link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Certificats d'importation"] .  Une fois vos certificats importés, vous pouvez tenter une nouvelle mise à niveau.
