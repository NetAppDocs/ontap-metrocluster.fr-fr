...
[role="lead"]
Effectuez une nouvelle installation ou une mise à niveau vers Tiebreaker 1.6 sur votre système d'exploitation Linux hôte pour surveiller les configurations MetroCluster.
...
--
.Mise à niveau de Tiebreaker 1.5 vers 1.6
--
...
--
.Mise à niveau de Tiebreaker 1.4 vers 1.6
--
