...
summary: 'Effectuez une nouvelle installation ou une mise à niveau vers Tiebreaker 1.6 sur votre système d"exploitation Linux hôte pour surveiller les configurations MetroCluster.' 
---
= Installez Tiebreaker 1.6 ou 1.6P1
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Effectuez une nouvelle installation ou une mise à niveau vers Tiebreaker 1.6 ou Tiebreaker 1.6P1 sur votre système d'exploitation Linux hôte pour surveiller les configurations MetroCluster.

.Description de la tâche
* Votre système de stockage doit exécuter ONTAP 9.12.1 ou une version ultérieure.
...
NOTE: Après avoir installé Tiebreaker 1.6 ou une version ultérieure, vous devez link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importer des certificats"] pour activer la surveillance transparente.



[[install-or-upgrade-to-tiebreaker-1-6p1]]
== Installation ou mise à niveau vers Tiebreaker 1.6P1

Vous pouvez installer Tiebreaker 1.6P1 ou mettre à niveau vers Tiebreaker 1.6P1 depuis Tiebreaker 1.6, 1.5 ou 1.4.

.Étapes
. Téléchargez le logiciel MetroCluster Tiebreaker 1.6P1.
+
...
. Si vous effectuez une mise à niveau, vérifiez la version de Tiebreaker que vous exécutez :
+
L'exemple suivant montre Tiebreaker 1.5.
...
----
. Installez ou mettez à niveau le logiciel Tiebreaker.
+
[role="tabbed-block"]
====
.Installer le Tiebreaker 1.6P1
--
Procéder comme suit pour une nouvelle installation de Tiebreaker 1.6P1.

.Étapes
.. Exécutez la commande suivante sur le `[root@mcctb ~] #` demander de commencer l'installation :
+
[source, cli]
----
...
--
.Mise à niveau 1.6 vers 1.6P1
--
Procédez comme suit pour mettre à niveau la version du logiciel Tiebreaker 1.6 vers Tiebreaker 1.6P1.


NOTE: Après la mise à niveau vers Tiebreaker 1.6P1 depuis la version 1.6, vous supprimez les moniteurs existants et ajoutez à nouveau la configuration MetroCluster pour la surveillance.

.Étapes
.. Exécutez la commande suivante sur le `[root@mcctb ~] #` demander la mise à niveau du logiciel :
+
[source, cli]
----
sh MetroClusterTiebreakerInstall-1.6P1
...
----
=====
.. Supprimez et ajoutez à nouveau la configuration MetroCluster en suivant les étapes de la section link:concept_configuring_the_tiebreaker_software.html["Configurer le logiciel disjoncteur d'attache"].


--
.Mise à niveau 1.5 vers 1.6P1
--
Procédez comme suit pour mettre à niveau la version du logiciel Tiebreaker 1.5 vers Tiebreaker 1.6P1.
...
--
.Mise à niveau 1.4 vers 1.6P1
--
Procédez comme suit pour mettre à niveau la version du logiciel Tiebreaker 1.4 vers Tiebreaker 1.6P1.
...
== Installez ou mettez à niveau vers Tiebreaker 1.6

Vous pouvez installer Tiebreaker 1.6 ou mettre à niveau vers Tiebreaker 1.6 depuis Tiebreaker 1.5 ou 1.4.

.Étapes
. Téléchargez le logiciel MetroCluster Tiebreaker 1.6.
+
https://mysupport.netapp.com/site/products/all/details/metrocluster-tiebreaker/downloads-tab["MetroCluster Tiebreaker (téléchargements) - site de support NetApp"^]
...
[role="tabbed-block"]
====
.Monter le Tiebreaker 1.6
--
Procéder comme suit pour une nouvelle installation de Tiebreaker 1.6.
...
--
.Mise à niveau 1.5 vers 1.6
--
Procédez comme suit pour mettre à niveau la version du logiciel Tiebreaker 1.5 vers Tiebreaker 1.6.
...
--
.Mise à niveau 1.4 vers 1.6
--
Procédez comme suit pour mettre à niveau la version du logiciel Tiebreaker 1.4 vers Tiebreaker 1.6.
...
.Et la suite ?
Une fois que vous avez installé ou mis à niveau Tiebreaker avec succès, link:configure-tb-workflow.html["configurer le logiciel MetroCluster Tiebreaker"] pour ajouter des configurations MetroCluster et importer les certificats requis.
