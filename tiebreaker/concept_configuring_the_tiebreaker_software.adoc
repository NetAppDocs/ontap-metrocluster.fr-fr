...
.Et la suite ?
link:task_configure_snmp_setts_for_tiebreaker_software.html["Configurer les paramètres SNMP pour le logiciel MetroCluster Tiebreaker"]
