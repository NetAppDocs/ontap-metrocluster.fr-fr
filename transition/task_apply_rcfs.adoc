...
NOTE: Si vous effectuez une migration d'un réseau FC à quatre nœuds vers un réseau IP à huit nœuds, vous pouvez appliquer le RCF FC à quatre nœuds vers IP à huit nœuds avant d'ajouter le deuxième groupe DR. Vous n'avez pas à appliquer d'abord le RCF FC à quatre nœuds vers IP à quatre nœuds.
