...
image::../media/four_node_transition_mcc_9151.png[Affiche les combinaisons de plateformes prises en charge pour la transition IP vers FC]

* Remarque 1 : cette combinaison de plates-formes nécessite ONTAP 9.13.1 ou une version ultérieure.
* Remarque 2 : une interface de 100 GbE est nécessaire pour les interfaces de cluster locales sur les nœuds FC. Cette combinaison de plates-formes nécessite ONTAP 9.11.1 ou une version ultérieure.
